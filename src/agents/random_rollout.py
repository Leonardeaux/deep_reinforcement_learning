...
class Node:
    def __init__(self, env: DeepEnv, done: bool, parent: Any, obs, action_index: int):
    ...
    def explore(self):
        ...
        while current_node.child:
            ...
            actions = [a for a, ch in child.items()]

            if len(actions) == 0:
                print("Error no max score action ")
...
class RandomRolloutAgent(DeepAgent):
    def __init__(self, env: DeepEnv, episodes: int = 10, max_depth: int = 100):
